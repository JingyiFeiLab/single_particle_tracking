...
cell_region_struct_2d = struct(field1,[],field2, [], field3, [], field4, [],field5, [],field6, [],field7, [],field8, [],field9, [],field10, [],field11, [],field12, [],field13, [],field14, [],field15, [],field16, []);
...
for ri = 1:length(cell_struct)
    ...
    if dapi_check = 1;
        ...
        cell_region_struct_2d(rid).Middle_Area = middle_definition*cell_struct(ri).Cell_Y_Axis*pi*(.5*percent_off_center*cell_struct(ri).Cell_X_Axis)^2;
    ...
    cell_region_struct_2d(rid).Pole_Diffusion = pole_diffusion;
    cell_region_struct_2d(rid).Membrane_Diffusion = membrane_diffusion;
    cell_region_struct_2d(rid).Middle_Diffusion = middle_diffusion;
    cell_region_struct_2d(rid).Cytoplasm_Diffusion = cytoplasm_diffusion;
    rid = rid + 1;
