...
dataset='/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/test.txt';                                          % Name of the datafile that you input....Lot of output files will have this "dataset" in their names
%set "dic_file" to image containg the dic image

dic_file = '/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/DIC_2_crop.tif';
dapi_file = '/Users/reyer/Documents/MATLAB/SOURCE_CODES/sample_images_matt/Matt_Microscope/h';
...
imshow(masklg);hold on;scatter(y*2,x*2,0.5,'g');
...
[new_mask,area,ellipticity,centers] = post_track_mask_July5(mask,d3,pixelscaling);
