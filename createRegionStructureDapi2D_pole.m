...
for ri = 1:length(cell_struct)
    ...
    pole_area_up = max([0,polyarea(pole_membrane_up(:,2),pole_membrane_up(:,1))]);
    pole_area_down = max([0,polyarea(pole_membrane_down(:,2),pole_membrane_down(:,1))]);
    ...
    cell_region_struct_2d(rid).Middle_Area = max([0,cell_region_struct_2d(rid).Middle_Area - polyarea(pole_middle_up(:,2),pole_middle_up(:,1)) - polyarea(pole_middle_down(:,2),pole_middle_down(:,1))]);
